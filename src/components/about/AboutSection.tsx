            ...
            <div className="space-y-3 p-6">
                ...
                <div className="bg-white rounded-xl text-left">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                        ...
                        일본에서는 다양한 복장과 헤어스타일, 혼밥·혼술 문화처럼 개인의 라이프스타일을 존중하는 분위기 속에서,
                        ...
                        <br/><br/>
                        졸업 후 프론트엔드 중심의 웹 개발 경력을 쌓아왔으며, 사용자 관점에서의 경험을 우선시하며 개발에 임했습니다.
                ...
                <div className="bg-white rounded-xl text-left">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                        ...
                        사람들과 소통을 하는 것에 있어 원동력을 느낍니다.
                        문제 해결 과정에서 깊이 몰입하는 스타일이며,
                        섬세함을 기반으로 기능 하나의 완성도를 높이기 위해 작은 디테일까지도 놓치지 않고 개발을 한 경험이 많습니다.
                    </p>
                </div>
